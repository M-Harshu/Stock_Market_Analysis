  ...
  return (
    <div className="min-h-screen pt-16 bg-[#1E3A8A] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold mb-8">About StockAnalytics</h1>

        <div className="bg-white/10 rounded-lg shadow-md p-8 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="bg-white/10 rounded-lg shadow-md p-6">
            <BarChart2 className="h-12 w-12 text-green-400 mb-4" />
